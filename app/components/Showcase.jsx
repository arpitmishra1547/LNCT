          ...
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-base italic font-normal leading-relaxed">
                LNCT Group of College is one of the Top engineering college in
                Bhopal, MP and Central India. LNCT Synonymous with excellence in
                higher education with 32+ Years of Academic Excellence and
                Discipline.
              </p>
            </div>
          </div>
