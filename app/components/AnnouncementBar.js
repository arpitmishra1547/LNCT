  ...
  return (
    <div className="flex items-center ml-16">
      ...
      <div className="flex items-center mr-4">
        <button className="bg-red-600 hover:bg-red-700 text-black text-sm font-medium py-1 px-3 rounded-md transition-colors duration-300 flex items-center">
      ...
      <div className="w-[60vw] h-[5vh] overflow-hidden flex items-center relative">
        ...
        <button 
          onClick={handlePrev}
          className="absolute left-0 z-10 p-2 text-black/60 hover:text-black/80 transition-colors duration-300"
        >
          <svg 
        ...
        >
          ...
          <div className="w-[60vw] flex-shrink-0 flex items-center justify-center">
            <span className="text-black/80 text-sm font-normal whitespace-nowrap max-w-[50vw] ml-8">
        ...
        <button 
          onClick={handleNext}
          className="absolute right-0 z-10 p-2 text-black/60 hover:text-black/80 transition-colors duration-300"
        >
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            className="h-5 w-5" 
      ...
      <div className="flex items-center space-x-6 ml-8">
        ...
        <div className="flex items-center space-x-2">
          <svg className="h-4 w-4 text-black/60" fill="currentColor" viewBox="0 0 24 24">
          ...
          <span className="text-black/60 text-xs">WhatsApp</span>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-black/60 text-xs">Call Us</span>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-black/60 text-xs">360°</span>
        </div>
      </div>
    </div>
  );
